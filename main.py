...
def process_verses(verses_list, output_dir="audio", voice="George", api_key=None):
    ...
    for verse_ref, verse_text in verses_list:
        # Create filename from verse reference
        filename = f"{verse_ref}.mp3"
...
if __name__ == "__main__":
    ...
    # Example text and output path
    # text = "Hola, esta es una prueba de la API de texto a voz de ElevenLabs."
    # output_file = "audio/output.mp3"
    
    # text_to_speech(text, output_file, api_key=API_KEY)
